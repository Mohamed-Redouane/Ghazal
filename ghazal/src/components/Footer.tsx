  ...
  return (
    <footer id="footer" className="relative bg-teal-dark overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-teal/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gold/3 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h3 className="text-4xl font-heading font-bold text-gold mb-4">
            Ghazal Restaurant
          </h3>
          <p className="text-primary-foreground/80 font-body text-lg max-w-2xl mx-auto">
            Une expérience culinaire raffinée inspirée de l'élégance de la gazelle
          </p>
